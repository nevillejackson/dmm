...
\subsection{The quercus program's demo2 dataset}
 The dataset {\em quercus.df} is a demonstrtation dataset from the program package QUERCUS, developed by Ruth G. Shaw and Frank H. Shaw. It is known to QUERCUS as the 'demo2' dataset. The QUERCUS program package is available from https://www.cbs.umn.edu/academics/departments/eeb/quercus. 
