...
\date{31 May 2024 \\
      For dmm\_2.1-10}   % Deleting this command produces today's date.
...
\subsection{The quercus program's demo2 dataset}
 The dataset {\em quercus.df} is a demonstrtation dataset from the program package QUERCUS, developed by Ruth G. Shaw and Frank H. Shaw. It is known to QUERCUS as the 'demo2' dataset. The QUERCUS program package is available from https://cbs.umn.edu/eeb/about-eeb/helpful-links/quercus-quantitative-genetics-software. 
...
> sheep.linefit <-  dmm(sheep.mdf,Cww ~ 1 + Sex + Year,
                   components=c("VarE(I)","VarG(Ia)","VarGlm(I)")
Dyadic mixed model fit for datafile: sheep.mdf  
Data file is a list containing a dataframe and a list of relationship matrices:
Random effect partitioned into components: Residual:
OLS-b step:
...
Anon (2014) UCLA: Statistical Computing Group. 
    From https://www.ats.ucla.edu/stat/faq/deltamethod.htm (accessed 8 Dec 2014)

\bibitem{bijm:06}
Bijma, P. (2006) Estimating maternal genetic effects in livestock.
    J. Anim. Sci. 84:800-806
    (https://doi.org/10.2527/2006.844800x)
...
Jouini, W. Le Guennec , D. and Moy, C  (2011) Log-Normal approximation of
    ...
    2011 XXXth URSI .
    From https://www.researchgate.net/publication/224263352\_Log-normal\_
